...
plot(sP(1,1:sNo)+randn(1,sNo)*0.05,sP(2,1:sNo)+randn(1,sNo)*0.05,'o','markersize',9,'linewidth',0.5,'color',ones(1,3)*0,'markerfacecolor',colorP)
...
set(gca,'xlim',rg,'ylim', rg,'dataaspectratio',[1 1 1],'box', 'off',...
    'fontsize', 16,'xtick',[0:10:50],'ytick',[0:10:50])
...
hold on
plot(sRG(1,1:sNo)+randn(1,sNo)*0.05,sRG(2,1:sNo)+randn(1,sNo)*0.05,'o','markersize',9,'linewidth',1,'color',ones(1,3)*0,'markerfacecolor',colorRG)
...
set(gca,'xlim',[0 4],'xtick',{},'fontsize',16,'ylim',[0 10],'ytick',0:5:10,'yticklabel',{0 50 100})
ylabel('firing rate')
...
set(gca,'xlim',[0 4],'xtick',{},'fontsize',16,'ytick',0:1:50)
...
set(gca,'xlim',[0 4],'xtick',{},'fontsize',16,'ytick',0:.1:.5)
